/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef703d627210e01f13357cda7b3ff941)
// Runtime types generated with workerd@1.20260721.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	jtk25_schedules: D1Database;
	ASSETS: Fetcher;
	ADMIN_PASS_GLOBAL: string;
	ADMIN_PASS_D3_1A: string;
	ADMIN_PASS_D3_1B: string;
	ADMIN_PASS_D3_2A: string;
	ADMIN_PASS_D3_2B: string;
	ADMIN_PASS_D3_3A: string;
	ADMIN_PASS_D3_3B: string;
	ADMIN_PASS_D3_3C: string;
	ADMIN_PASS_D4_1A: string;
	ADMIN_PASS_D4_1B: string;
	ADMIN_PASS_D4_1C: string;
	ADMIN_PASS_D4_1D: string;
	ADMIN_PASS_D4_2A: string;
	ADMIN_PASS_D4_2B: string;
	ADMIN_PASS_D4_2C: string;
	ADMIN_PASS_D4_2D: string;
	ADMIN_PASS_D4_3A: string;
	ADMIN_PASS_D4_3B: string;
	ADMIN_PASS_D4_4A: string;
	ADMIN_PASS_D4_4B: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASS_GLOBAL" | "ADMIN_PASS_D3_1A" | "ADMIN_PASS_D3_1B" | "ADMIN_PASS_D3_2A" | "ADMIN_PASS_D3_2B" | "ADMIN_PASS_D3_3A" | "ADMIN_PASS_D3_3B" | "ADMIN_PASS_D3_3C" | "ADMIN_PASS_D4_1A" | "ADMIN_PASS_D4_1B" | "ADMIN_PASS_D4_1C" | "ADMIN_PASS_D4_1D" | "ADMIN_PASS_D4_2A" | "ADMIN_PASS_D4_2B" | "ADMIN_PASS_D4_2C" | "ADMIN_PASS_D4_2D" | "ADMIN_PASS_D4_3A" | "ADMIN_PASS_D4_3B" | "ADMIN_PASS_D4_4A" | "ADMIN_PASS_D4_4B" | "FIREBASE_SERVICE_ACCOUNT">> {}
}

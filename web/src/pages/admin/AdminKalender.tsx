              ...
              {data.map((e) => (
                <tr key={e.id} className="border-b border-gray-200 dark:border-gray-700 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <td className="px-4 py-3">
                    ...
                    {e.class_name && <div className="text-xs text-gray-400 dark:text-gray-500">{e.class_name.replace(/_/g, '-')}</div>}
                  </td>
                  <td className="px-4 py-3 text-gray-600 dark:text-gray-400 whitespace-nowrap">{e.date}</td>
